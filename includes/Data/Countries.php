...
class Countries {
    ...
    public function find_country_code($name) {
        ...
        // Check if it's already a country code (case-insensitive)
        $upper_code = strtoupper($search_name);
        if (isset($this->countries[$upper_code])) {
            return $upper_code;
        }
...
$variations = [
     ...
     */
    public function get_countries($enabled_only = false) {
