...
class Manager {
    ...
    public static function init() {
        ...
        error_log('ClaimsAngel User Manager Init Called');
        ...
        // Debug: Add action to check if we're on the right page
        add_action('admin_init', function() {
            global $pagenow;
            if ($pagenow === 'user-new.php') {
                error_log('ClaimsAngel: On user-new.php page');
            }
        });
    }
    ...
    public static function add_country_field_to_form($user) {
        ...
        error_log('ClaimsAngel add_country_field_to_form called');
        ...
        error_log('ClaimsAngel Countries Data: ' . print_r($countries, true));
        ...
        error_log('ClaimsAngel add_country_field_to_form completed');
    }
