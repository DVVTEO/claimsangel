...
class PostTypeManager {
    ...
    private function register_business_post_type() {
        ...
        $args = [
            'labels'              => $labels,
            'public'              => true, // Set to false to make it private
            'publicly_queryable'  => true, // Prevent public queries
     ...
     * Registers post types and flushes rewrite rules.
     */
    public static function activate() {
        // Create an instance to register the post types.
        $manager = new self();
...
// If this file is being run in the context of plugin activation/deactivation,
// add the activation and deactivation hooks.
if ( defined( 'ABSPATH' ) && function_exists( 'register_activation_hook' ) ) {
    register_activation_hook( __FILE__, [ 'ClaimsAngel\PostTypes\PostTypeManager', 'activate' ] );
    register_deactivation_hook( __FILE__, [ 'ClaimsAngel\PostTypes\PostTypeManager', 'deactivate' ] );
}